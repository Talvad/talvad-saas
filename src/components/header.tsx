		...
		<header className="sticky top-0 z-50 shadow-md px-4 backdrop-blur-lg flex justify-between items-center">
			...
			<div className="flex justify-between items-center px-8 h-16 w-full max-w-screen-2xl mx-auto">
				...
				<div className="flex items-center gap-4">
					<button className="hidden sm:block text-slate-500 hover:bg-slate-50 p-2 rounded-lg transition-colors">
						<span className="material-symbols-outlined">settings</span>
					</button>
					<button className="px-5 py-2 rounded-lg bg-indigo-600 text-white font-manrope font-bold text-sm active:scale-90 transform transition-transform duration-200">
						Get Started
					</button>
				</div>
			</div>
